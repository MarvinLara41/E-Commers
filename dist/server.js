...
const mongodbURI = _config.default.MONGODB_URI;
...
app.use(
	'/uploads',
	_express.default.static(_path.default.join(__dirname, '/../uploads'))
);
app.use(
	_express.default.static(_path.default.join(__dirname, '/../client/build'))
);
app.get('*', (req, res) => {
